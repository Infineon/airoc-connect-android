...
public class NotificationHandler {
    ...
    private static final String CHANNEL_ID_IN_PROGRESS = "com.infineon.airocbluetoothconnect.OTAFirmwareUpdate.InProgress";
    private static final String CHANNEL_ID_DONE = "com.infineon.airocbluetoothconnect.OTAFirmwareUpdate.Done";
    ...
    public void initializeNotification(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel inProgressChannel = new NotificationChannel(
                    CHANNEL_ID_IN_PROGRESS,
                    context.getString(R.string.ota_notification_fu_inprogress),
            ...
            NotificationChannel doneChannel = new NotificationChannel(
                    CHANNEL_ID_DONE,
                    context.getString(R.string.ota_notification_fu_done),
    ...
    public void generatePendingNotification(Context context) {
        ...
        PendingIntent resultPendingIntent = PendingIntent.
                getActivity(context, requestID, resultIntent,
    ...
    public void completeProgress(Context context, int contentTextResourceId) {
        ...
        // mNotificationManager.notify(mNotificationId, mBuilder.build());
        // Immediate notifications sometimes are skipped on Samsung devices.
        // Postpone the notification
        mDelayedNotificationHandler.postDelayed(() -> mNotificationManager.notify(mNotificationId, mBuilder.build()), 1000);
    }
